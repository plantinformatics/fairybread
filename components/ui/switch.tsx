...
const switchVariants = cva(
  `
    ...
    disabled:cursor-not-allowed disabled:opacity-50 data-unchecked:bg-input
...
const switchThumbVariants = cva(
  "pointer-events-none block bg-white w-1/2 h-[calc(100%-4px)] shadow-lg ring-0 transition-transform start-0 data-unchecked:translate-x-[2px] data-checked:translate-x-[calc(100%-2px)] rtl:data-unchecked:-translate-x-[2px] rtl:data-checked:-translate-x-[calc(100%-2px)]",
  {
    variants: {
      shape: {
        pill: 'rounded-full',
    ...
    compoundVariants: [
      {
        ...
        permanent: false,
        className:
          "text-primary-foreground peer-data-unchecked:invisible peer-data-unchecked:translate-x-full rtl:peer-data-unchecked:-translate-x-full",
      },
      {
        state: 'off',
        permanent: false,
        className:
          "peer-data-checked:invisible -translate-x-full rtl:translate-x-full peer-data-unchecked:translate-x-0",
      },
      {
        state: 'on',
        permanent: true,
