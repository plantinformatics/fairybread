export default function BottomFooter() {
  return (
    <div className="flex items-start justify-end mt-6 mb-6 gap-4">
        ...
        {/* <img src="/grdc3.svg" alt="GRDC 3" className="w-1/5 h-auto" />
        <img src="/agiVic.svg" alt="AGI Vic" className="w-1/5 h-auto" />
        <img src="/grdc2.svg" alt="GRDC 2" className="w-1/5 h-auto" /> */}
